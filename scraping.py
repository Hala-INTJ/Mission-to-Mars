...
def mars_hemispheres(browser):
    ...
    try:
        for i in range(4):
            ...
            divs_img = images_soup.find('div', class_='downloads')
            img_url= divs_img.find('a')['href']
            divs_title = images_soup.find('div', class_='content')
            title = divs_title.find('h2').get_text()
            hemispheres = {}
